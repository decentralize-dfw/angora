...
`layer-manifest.json` dosya bütünlüğünü, `layer-qa.json` yeniden açılma kontrolünü kaydeder. Bu sürüm fotoğraf karşılaştırması içindir; nihai satış modeli değildir. Güncel renderlar `build/renders/render-manifest.json` ile takip edilir.
