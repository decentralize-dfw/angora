...
for o in objects:
    ...
    for floor,z in enumerate([0,3.0996,6.3714]):
...
report={'status':'passed' if not hits else 'failed','foreign_fixture_intersections':hits,'scope':'fixed fittings and furniture, usable lift cabin volumes on three landings; attic unserved'}
