...
test('All native room starts and thirteen open door passages are navigable',{skip:!manifest.native_delivery},()=>{
  ...
  const doors=read('build/qa/roads-native/door-regression.json');assert.equal(doors.length,13);
