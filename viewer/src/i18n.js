...
const STRINGS = {
  tr: {
    ...
    creditRole: 'Proje geliştiricisi ve sahibi',
    ...
    language: 'Dil', interiorLights: 'İç ışıklar', soundOff: 'Arayüz sesi kapalı', soundOn: 'Arayüz sesi açık',
    ...
    welcomeVR: 'VR ile gez', welcomeExplore: 'Evi keşfet', welcomeTour: 'Sesli tur', welcomeClose: 'Kapat',
    welcomeNote: 'Alanlar RE/MAX P56131836 ilanındandır',
    factGross: 'brüt', factNet: 'net', factRooms: 'oda', factFloors: 'kat',
    tourStop: 'Turu bitir', tourPause: 'Duraklat', tourResume: 'Devam et', tourSeek: 'Turda ilerle',
    tourAudioFailed: 'Ses kaydı yüklenemedi. Evi kendiniz gezmeye devam edebilirsiniz.',
    tourPhotos: 'Anlatılan odadan fotoğraflar', tourSpeed: 'Anlatım hızı',
  ...
  en: {
    ...
    creditRole: 'Owner and developer',
    ...
    language: 'Language', interiorLights: 'Interior lights', soundOff: 'Interface sound off', soundOn: 'Interface sound on',
    ...
    welcomeVR: 'Start immersive', welcomeExplore: 'Explore the home', welcomeTour: 'Narrated tour', welcomeClose: 'Close',
    welcomeNote: 'Areas are from the RE/MAX listing P56131836',
    factGross: 'gross', factNet: 'net', factRooms: 'rooms', factFloors: 'floors',
    tourStop: 'End tour', tourPause: 'Pause', tourResume: 'Resume', tourSeek: 'Move through the tour',
    tourAudioFailed: 'The recording could not be loaded. You can still explore the house yourself.',
    tourPhotos: 'Photographs of the room being described', tourSpeed: 'Narration speed',
