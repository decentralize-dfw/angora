...
const STRINGS = {
  tr: {
    ...
    welcomeVR: 'VR ile gez', welcomeExplore: 'Evi keşfet', welcomeTour: 'Rehberli tur', welcomeClose: 'Kapat',
  ...
  en: {
    ...
    welcomeVR: 'Start immersive', welcomeExplore: 'Explore the home', welcomeTour: 'Guided tour', welcomeClose: 'Close',
